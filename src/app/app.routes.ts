...
import { WaterQualityComponent } from './comps/water-quality-monitor/water-quality-monitor.component';
...
export const routes: Routes = [
	...
	{ path: 'water-quality', component: WaterQualityComponent, canActivate: [AuthGuard] },
